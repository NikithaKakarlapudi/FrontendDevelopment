...
import InfoIcon from '@mui/icons-material/Info';
 function TitlebarImageListExm() {
  return (
    <div>
        <h2>TitlebarImageListExm</h2>
    <ImageList sx={{ width: 500, height: 450 }}>
      <ImageListItem key="Subheader" cols={2}>
        <ListSubheader component="div">Home décor picks from local shops</ListSubheader>
      </ImageListItem>
      {itemData.map((item) => (
...
const itemData = [
 ...
 function TitlebarBelowImageListExm() {
    return (
        <div>
            <h2>TitlebarBelowImageList</h2>
      <ImageList sx={{ width: 500, height: 450 }}>
        {itemValue.map((item) => (
          <ImageListItem key={item.img}>
            <img
...
export default TitlebarImageListExm;
